...
class config:
    ...
    num_gpus = 8
    num_nodes = 1
    load_path = "checkpoints/meter_clip16_288_roberta_coco.ckpt"  # this should point to the downloaded meter checkpoint
    num_workers = 8
    precision = 32

    # Reset params for coco finetuned model
    # task_finetune_irtr_coco_clip_bert
